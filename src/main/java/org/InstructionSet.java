...
import static org.InstructionType.*;
...
public enum InstructionSet {
    ...
    INVOKEDYNAMIC(0xBA,-1,-1,2,INVOKE),
    ...
    public final short operand;
    public final InstructionType type;
    InstructionSet(byte opcode,int pop,int put,short operand,InstructionType type){
        this.opcode = opcode;
        this.pop = pop;
        this.put = put;
    ...
    InstructionSet(int opcode,int pop,int put,int operand,InstructionType type){
        this((byte) opcode,pop,put,(short) operand,type);
    }
